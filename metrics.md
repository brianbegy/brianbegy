...
* If our metrics ever seem to be driving the wrong behavior, we need to stop and talk about it.  See [Feedback](feedback.md)
...
PR throughput measures how many changes we each get to production.
...
I am a strong believer that every developer should write and commit code every day.  
